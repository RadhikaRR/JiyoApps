...
public class ProductwiseMISScreen extends MainScreen {

	private GridFieldManager grid2;

	public ProductwiseMISScreen(Hashtable productMIShashtable) {
		super(Manager.HORIZONTAL_SCROLL | Manager.VERTICAL_SCROLL);

		showTable(productMIShashtable);
	}
	...
	private void showTable(Hashtable hashtable) {
		...
		LabelFieldImpl tableTitle = new LabelFieldImpl("Productwise MIS",
				FIELD_HCENTER);
		...
		ftdUlipTotalLbl.setFont(myFont);
		...
		mtdUlipTotalLbl.setFont(myFont);
		...
		ytdUlipTotalLbl.setFont(myFont);
