...
public class BMScoreCardScreen extends MainScreen {
	private GridFieldManager Grid, Grid1;
	private Font myfont;

	public BMScoreCardScreen(Hashtable hashtable) {
		...
		ShowBMGridTable(hashtable);
		ShowBMGridTable2(hashtable);
	...
	public void ShowBMGridTable(Hashtable hashtable) {

		Grid = new GridFieldManager(6, 4, FIELD_HCENTER | USE_ALL_WIDTH);
		...
		BorderLabelFieldImpl b5 = new BorderLabelFieldImpl(
				"% Achv on Credited Premium", USE_ALL_WIDTH | Field.FOCUSABLE);
		Grid.add(b5);
	...
	public void ShowBMGridTable2(Hashtable hashtable) {
